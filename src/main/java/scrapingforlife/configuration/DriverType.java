    ...
    OPERA {
        public RemoteWebDriver getWebDriverObject(DesiredCapabilities capabilities) {
        	if(System.getProperty("webdriver.opera.driver") == null) {
                    ...
                    try {
                        System.setProperty("webdriver.opera.driver", TestThread.getProp().getProperty("webdriver.binary.path"));
                    } catch (IOException ex) {
                        JOptionPane.showMessageDialog(null, "Webdriver not found!");
                    }
            ...
            try {
                options.setBinary(TestThread.getProp().getProperty("browser.binary.path"));
            } catch (IOException ex) {
